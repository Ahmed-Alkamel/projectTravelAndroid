...
class UserRequest {
  ...
  @override
  String toString() {
    return 'UserRequest(idCustomerRequsts: $idCustomerRequsts, serviceName: $serviceName, state: $state, idCus: $idCus, employees: $employees, requestTrip: $requestTrip, requestServicePublic: $requestServicePublic, serviceDetails: $serviceDetails)';
  }
...
class Employees {
  ...
  @override
  String toString() =>
      'Employees(name: $name, address: $address, salary: $salary)';
  ...
  @override
  int get hashCode => name.hashCode ^ address.hashCode ^ salary.hashCode;
}
