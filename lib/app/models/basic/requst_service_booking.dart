...
class DataInputRequrment extends Equatable {
  int? idprim;
  int? id;
  ...
  @override
  String toString() {
    return 'DataInputRequrment(id: $id, mainRequire: $mainRequire, subReqDetail: $subReqDetail, textValue: $textValue, idTypeFiled: $idTypeFiled, urlFile: $urlFile, idChoice: $idChoice, stateOfRequiremnt: $stateOfRequiremnt)';
  }
